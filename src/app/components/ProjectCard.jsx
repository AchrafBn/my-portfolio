  ...
  return (
    ...
    >
      <div className="overlay justify-center items-center  text-center absolute rounded-xl top-0 left-0 w-full h-full bg-[#f2f2f2] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-90 transition-all duration-500 ">
        <div>
          <h5 className="text-2xl text-balticSea  font-semibold mb-2">
            {title}
          </h5>
          <p className="mx-4 text-md font-medium text-balticSea">
            {description}
          </p>
          ...
          <div className="my-2">
            {tools.map((name) => (
              <>
                <span className=" text-white  bg-violet-900 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full">
                  {" "}
                  {name}
                </span>
              </>
